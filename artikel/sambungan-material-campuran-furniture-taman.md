---
article_id: LTM-11-06
title: "Komponen Kayu, Batu, dan Logam dalam Furniture Taman"
slug: "sambungan-material-campuran-furniture-taman"
...
date_modified: null
parent_topic: LTM-11
primary_intent: "Coordinate mixed-material furniture"
reader_community: "Taman.co.id"
reader_address: "Sobat Taman.co.id"
final_route: "/artikel/sambungan-material-campuran-furniture-taman.html"
...
# Komponen Kayu, Batu, dan Logam dalam Furniture Taman

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Komponen Kayu, Batu, dan Logam dalam Furniture Taman”
...
- **Primary intent:** Coordinate mixed-material furniture
...
- **Scope boundary:** Material-interface focus, not broad galvanic joint detailing.
- **Final public route:** `/artikel/sambungan-material-campuran-furniture-taman.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Komponen Kayu, Batu, dan Logam dalam Furniture Taman**.
...
- `/kerajinan-tembaga-kuningan-di-batu-bara` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kerajinan-tembaga-kuningan-di-batu` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/furniture/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Komponen Kayu, Batu, dan Logam dalam Furniture Taman”.
