---
article_id: LTM-16-05
title: "Quality Control Workshop Sebelum Produk Logam Dikirim"
slug: "qc-workshop-produk-logam"
...
date_modified: null
parent_topic: LTM-16
primary_intent: "Verify fabrication before shipment"
reader_community: "Taman.co.id"
reader_address: "Kawan Taman.co.id"
final_route: "/artikel/qc-workshop-produk-logam.html"
...
# Quality Control Workshop Sebelum Produk Logam Dikirim

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Quality Control Workshop Sebelum Produk Logam Dikirim”
...
- **Primary intent:** Verify fabrication before shipment
...
- **Scope boundary:** Factory QA focus; site acceptance is covered by LTM-14.
- **Final public route:** `/artikel/qc-workshop-produk-logam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Quality Control Workshop Sebelum Produk Logam Dikirim**.
...
- `LTM-16-03` → `/artikel/urutan-persetujuan-sampel-logam.html` — Material Sample, Finish Chip, dan Mockup: Urutan Persetujuan
...
- `LTM-16-06` → `/artikel/paket-handover-logam-taman.html` — Paket Handover Logam Taman: As-Built, Finish, Garansi, dan Maintenance
...
- **Tie back to this article:** Keep the explanation specific to “Quality Control Workshop Sebelum Produk Logam Dikirim”.
