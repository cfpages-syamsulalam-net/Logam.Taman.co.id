---
article_id: LTM-11-04
title: "Meja dan Furniture Logam untuk Area Semi-Outdoor"
slug: "furniture-logam-area-semi-outdoor"
...
date_modified: null
parent_topic: LTM-11
primary_intent: "Adapt furniture to sheltered exposure"
reader_community: "Taman.co.id"
reader_address: "Kawan Taman.co.id"
final_route: "/artikel/furniture-logam-area-semi-outdoor.html"
...
# Meja dan Furniture Logam untuk Area Semi-Outdoor

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Meja dan Furniture Logam untuk Area Semi-Outdoor”
...
- **Primary intent:** Adapt furniture to sheltered exposure
...
- **Scope boundary:** Furniture exposure focus; existing `/furniture` owns product browsing.
- **Final public route:** `/artikel/furniture-logam-area-semi-outdoor.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Meja dan Furniture Logam untuk Area Semi-Outdoor**.
...
- `LTM-11-03` → `/artikel/detail-edging-logam-taman.html` — Edging Logam Taman: Tepi Aman, Gerak Tanah, dan Perawatan
...
- `LTM-11-06` → `/artikel/sambungan-material-campuran-furniture-taman.html` — Komponen Kayu, Batu, dan Logam dalam Furniture Taman
...
- **Tie back to this article:** Keep the explanation specific to “Meja dan Furniture Logam untuk Area Semi-Outdoor”.
