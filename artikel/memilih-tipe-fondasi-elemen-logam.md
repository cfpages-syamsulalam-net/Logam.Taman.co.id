---
article_id: LTM-04-03
title: "Fondasi Terpisah atau Terhubung ke Struktur Eksisting?"
slug: "memilih-tipe-fondasi-elemen-logam"
...
date_modified: null
parent_topic: LTM-04
primary_intent: "Frame a foundation decision"
reader_community: "Taman.co.id"
reader_address: "Sobat Taman.co.id"
final_route: "/artikel/memilih-tipe-fondasi-elemen-logam.html"
...
# Fondasi Terpisah atau Terhubung ke Struktur Eksisting?

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Fondasi Terpisah atau Terhubung ke Struktur Eksisting?”
...
- **Primary intent:** Frame a foundation decision
...
- **Scope boundary:** Decision questions, not foundation dimensions or reinforcement.
- **Final public route:** `/artikel/memilih-tipe-fondasi-elemen-logam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Fondasi Terpisah atau Terhubung ke Struktur Eksisting?**.
...
- `LTM-04-01` → `/artikel/jalur-beban-elemen-logam-taman.html` — Memahami Jalur Beban pada Elemen Logam Taman
- `LTM-04-02` → `/artikel/risiko-angin-pada-elemen-logam.html` — Angin pada Panel, Artwork, dan Papan Logam Outdoor
- `LTM-04-04` → `/artikel/koordinasi-base-plate-dan-anchor-bolt.html` — Base Plate dan Anchor Bolt: Data yang Harus Dikoordinasikan
...
- **Tie back to this article:** Keep the explanation specific to “Fondasi Terpisah atau Terhubung ke Struktur Eksisting?”.
