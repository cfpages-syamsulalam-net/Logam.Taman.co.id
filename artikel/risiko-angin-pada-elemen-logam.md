---
article_id: LTM-04-02
title: "Angin pada Panel, Artwork, dan Papan Logam Outdoor"
slug: "risiko-angin-pada-elemen-logam"
...
date_modified: null
parent_topic: LTM-04
primary_intent: "Identify wind-sensitive objects"
reader_community: "Taman.co.id"
reader_address: "Kawan Taman.co.id"
final_route: "/artikel/risiko-angin-pada-elemen-logam.html"
...
# Angin pada Panel, Artwork, dan Papan Logam Outdoor

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Angin pada Panel, Artwork, dan Papan Logam Outdoor”
...
- **Primary intent:** Identify wind-sensitive objects
...
- **Scope boundary:** Screening only; project wind calculation requires an engineer.
- **Final public route:** `/artikel/risiko-angin-pada-elemen-logam.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Angin pada Panel, Artwork, dan Papan Logam Outdoor**.
...
- **Tie back to this article:** Keep the explanation specific to “Angin pada Panel, Artwork, dan Papan Logam Outdoor”.
